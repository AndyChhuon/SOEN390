...
const PropertyProfileScreen = ({ navigation }) => {
 ...
 const addFilesToProperty = () => {
  return (
   ...
   >
    {Object.keys(userValues.propertiesOwned).map((propertyId) => (
     <View
      key={propertyId}
      style={{
       padding: 20,
      ...
      <View>
       ...
       >
        ...
        <ThemedButton
         ...
         onPress={() => navigation.navigate("FinancialSystem", { propertyId })}
        >
         <MaterialIcon
          style={{ marginRight: 5 }}
          name="money-bill"
          ...
          <View>
           <View style={styles.textFieldWrapStyle}>
            <TextInput
             id="p_name"
             width={0.8 * width}
             onChangeText={(value) => updateState({ propertyName: value })}
           ...
           <View>
            <View style={styles.textFieldWrapStyle}>
             <TextInput
              id="u_count"
              width={0.9 * width}
              onChangeText={(value) => updateState({ unitCount: value })}
           ...
           <View>
            <View style={styles.textFieldWrapStyle}>
             <TextInput
              id="p_count"
              width={0.9 * width}
              onChangeText={(value) => updateState({ parkingCount: value })}
           ...
           <View>
            <View style={styles.textFieldWrapStyle}>
             <TextInput
              id="l_count"
              width={0.9 * width}
              onChangeText={(value) => updateState({ lockerCount: value })}
